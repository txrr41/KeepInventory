...
procedure TPedidoMoviController.AdicionarMovimentacao(
...
function TPedidoMoviController.DtoForModel(
...
procedure TPedidoMoviController.EditarMovimentacao(
  AMovimentacaoDTO: TMovimentacaoDTO);
var
  MovimentacaoModel: TMovimentacaoConfig;
begin
...
procedure TPedidoMoviController.ExcluirMovimentacao(AId: Integer);
begin
  FMovimentacaoService.ExcluirMovimentacao(AId);
end;

function TPedidoMoviController.ListarMovimentacoes: TDataSet;
begin
  Result := FMovimentacaoService.ListarMovimentacoes;
end;

function TPedidoMoviController.PesquisarMovimentacao(
  const aSearch: String): TDataSet;
begin
  Result := FMovimentacaoService.PesquisarMovimentacao(aSearch);
end;

procedure TPedidoMoviController.PopularComboBoxPatrimonios(
  AComboBox: TComboBox);
var
...
procedure TPedidoMoviController.PopularComboBoxSalas(AComboBox: TComboBox);
var
  NomesComIDs: TStringList;
begin
...
procedure TPedidoMoviController.PopularComboBoxSalasDoPatrimonio(
