...
destructor TFormConnection.Destroy;
begin
  FController.Free;
  inherited;
end;
...
procedure TFormConnection.Image2Click(Sender: TObject);
begin
Self.Close;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      // Fecha o form de conexão APÓS abrir o login
      Self.Close;
    end
    else
    ...
    Config.Free;
    // NÃO faça FormConnection.Free aqui!
  end;
end;
